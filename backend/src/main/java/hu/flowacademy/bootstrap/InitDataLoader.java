...
public class InitDataLoader implements CommandLineRunner {
    ...
    private void executeFlightSave(User user) {
        ...
        Flight flight1 = Flight.builder().city("London").destination("Lisbon")
                ...
                .arrival(LocalDateTime.parse("2021-03-05 10:45", formatter)).isUpcoming(false)
                .plane("Airbus A319-100").user(user).build();
        list.add(flight1);
        Flight flight2 = Flight.builder().city("Athens").destination("Paris")
                .departure(LocalDateTime.parse("2021-04-09 09:45", formatter))
                .arrival(LocalDateTime.parse("2021-04-10 13:45", formatter)).isUpcoming(false)
                .plane("Boeing 747-400").user(user).build();
        list.add(flight2);
        Flight flight3 = Flight.builder().city("Amsterdam").destination("Barcelona")
                ...
                .arrival(LocalDateTime.parse("2021-04-14 17:45", formatter)).isUpcoming(false)
                .plane("Airbus A321-100").user(user).build();
        list.add(flight3);
        Flight flight4 = Flight.builder().city("Rome").destination("Istanbul")
                .departure(LocalDateTime.parse("2021-05-23 22:07", formatter))
                .arrival(LocalDateTime.parse("2021-05-25 03:45", formatter)).isUpcoming(false)
        ...
        Flight flight5 = Flight.builder().city("Berlin").destination("Prague")
                ...
                .arrival(LocalDateTime.parse("2021-06-12 19:56", formatter)).isUpcoming(false)
        ...
        Flight flight6 = Flight.builder().city("Dublin").destination("Berlin")
                ...
                .arrival(LocalDateTime.parse("2020-09-05 11:05", formatter)).isUpcoming(false)
                .plane("Boeing 747-400").user(user).build();
        list.add(flight6);
        Flight flight7 = Flight.builder().city("Munich").destination("Vienna")
                .departure(LocalDateTime.parse("2020-02-26 11:09", formatter))
                .arrival(LocalDateTime.parse("2020-02-28 21:25", formatter)).isUpcoming(false)
        ...
        Flight flight10 = Flight.builder().city("Munich").destination("Vienna")
                ...
                .arrival(LocalDateTime.parse("2021-01-02 06:45", formatter)).isUpcoming(false)
                .plane("Airbus A330-300").user(user).build();
        list.add(flight10);
